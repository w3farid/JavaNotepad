...
public class FontHelper extends JDialog implements ListSelectionListener {
    ...
    JLabel fontLabel, sizeLabel, typeLabel, prevewLabel;
    ...
    public FontHelper() {
        ...
        gbc.gridheight = 1;
        gbc.anchor = GridBagConstraints.WEST;
        String[] size = {"8", "10", "12", "14", "16", "18", "20", "22", "24", "28", "32", "48", "72"};
        ...
        prevewLabel = new JLabel("Preview :");
        pan1.add(prevewLabel);
        ...
        label = new JTextField("The quack brown for jumps");
